...
assert.equal(symbolContext.contextIndex.stored, true);
assert.match(symbolContext.contextIndex.storageHint, /^\.zero\/cache\/native\/context-[0-9a-f]{16}\.cache$/);
assert(symbolContext.contextIndex.invalidatesOn.includes("source"));
assert.match(symbolContext.contextIndex.inputs.sourceSetHash, /^[0-9a-f]{16}$/);
