...
bin/zero context --json --symbol main examples/resource-cli > .zero/native-test/resource-cli-context.json
...
grep -q '"sources"' .zero/native-test/resource-cli-context.json
grep -q 'pub fun main' .zero/native-test/resource-cli-context.json
